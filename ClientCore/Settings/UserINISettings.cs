...
namespace ClientCore
{
    public class UserINISettings
    {
        ...
        public static UserINISettings Instance
        {
            ...
            {
                if (_instance == null)
                    throw new InvalidOperationException("UserINISettings not initialized!".L10N("Client:Exceptions:InvalidOperationException1"));
        ...
        {
            if (_instance != null)
                throw new InvalidOperationException("UserINISettings has already been initialized!".L10N("Client:Exceptions:InvalidOperationException2"));
        ...
        protected UserINISettings(IniFile iniFile)
        {
            ...
            IngameScreenWidth = new IntSetting(iniFile, VIDEO, "ScreenWidth", 1280);
            IngameScreenHeight = new IntSetting(iniFile, VIDEO, "ScreenHeight", 800);
