...
namespace ClientCore
{
    public class ClientConfiguration
    {
        ...
        public string WindowTitle => clientDefinitionsIni.GetStringValue(SETTINGS, "WindowTitle", string.Empty).L10N("INI:ClientDefinitions:WindowTitle");
        ...
        public bool UseMinecraftTranslationFormat => clientDefinitionsIni.GetBooleanValue(SETTINGS, "UseMinecraftTranslationFormat", false);
        ...
        public bool AgeVerify => clientDefinitionsIni.GetBooleanValue(SETTINGS, "AgeVerify", System.Threading.Thread.CurrentThread.CurrentCulture.Name == "zh-CN");
        public bool CrabsInRivers => clientDefinitionsIni.GetBooleanValue(SETTINGS, "CrabsInRivers", System.Threading.Thread.CurrentThread.CurrentCulture.Name == "zh-CN");
