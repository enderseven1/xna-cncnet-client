    ...
    static class PreStartup
    {
        ...
        public static void Initialize(StartupParams parameters)
        {
            ...
            try
            {
                ...
                FileInfo translationThemeFile;
                FileInfo translationFile;

                if (ClientConfiguration.Instance.UseMinecraftTranslationFormat)
                {
                    translationThemeFile = SafePath.GetFile(ClientConfiguration.Instance.GetThemePath(UserINISettings.Instance.ClientTheme), UserINISettings.Instance.Translation + ".ini");
                    translationFile = SafePath.GetFile(ClientConfiguration.Instance.TranslationsFolderPath, UserINISettings.Instance.Translation + ".ini");
                }
                else
                {
                    translationThemeFile = SafePath.GetFile(UserINISettings.Instance.TranslationThemeFolderPath, ClientConfiguration.Instance.TranslationIniName);
                    translationFile = SafePath.GetFile(UserINISettings.Instance.TranslationFolderPath, ClientConfiguration.Instance.TranslationIniName);
                }
