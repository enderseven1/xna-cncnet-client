...
namespace DTAClient.DXGUI.Multiplayer.CnCNet
{
    public class PrivateMessagingWindow : XNAWindow, ISwitchable
    {
        ...
        private const string RECENT_PLAYERS_TEXT = "最近游玩：";
        ...
        public override void Initialize()
        {
            ...
            tabControl.AddTab("我的私信", UIDesignConstants.BUTTON_WIDTH_133);
            tabControl.AddTab("我的好友", UIDesignConstants.BUTTON_WIDTH_133);
            tabControl.AddTab("全服玩家", UIDesignConstants.BUTTON_WIDTH_133);
            tabControl.AddTab("最近遇见", UIDesignConstants.BUTTON_WIDTH_133);
