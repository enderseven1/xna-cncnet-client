...
namespace DTAClient.DXGUI.Generic
{
    public class StatisticsWindow : XNAWindow
    {
        ...
        public override void Initialize()
        {
            ...
            chkIncludeSpectatedGames.Text = "显示观战记录";
            ...
            lbGameStatistics.AddColumn("胜出", 50);
            ...
            AddTotalStatisticsLabel("lblWinLossRatio", "胜负比：", new Point(TOTAL_STATS_LOCATION_X1, locationY));
        ...
        {
            var msgBox = new XNAMessageBox(WindowManager, "清除统计数据",
                "所有统计数据都将从数据库里清除。" +
